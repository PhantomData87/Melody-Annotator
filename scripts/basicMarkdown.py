...
class markdownView():                                                                                                                                                                                           # Welcome to more verboose comments. Again run the function found in melodyCore.py to remove them
    def __init__(self, root, startText, pad, location, colorPallet = ("#AAAAAA", "#272738", "#DDDDDD")):                                                                                                        # We only want to take in the bare minimum.
        ...
        self.root.bind_class("basicMarkdown", '<Key>', self.updateText)                                                                                                                                         # Whenever you type, all text is added to all 3 interfaces (does not detect newline)
        ...
        self.root.bind_class("basicMarkdown", '<Return>', self.updateText, add="+")                                                                                                                             # Whenever you type, all newlines are added to all 3 interfaces
    ...
    def cycleView(self):                                                                                                                                                                                        # This is ran change the tpye of interface you see when you press the button
        if self.current == "r":                                                                                                                                                                                 # If raw interface
            self.previewInterface.tkraise()                                                                                                                                                                     # Raise to top previewInterface
            self.current = "p"                                                                                                                                                                                  # Set to previewInterface
        elif self.current == "p":                                                                                                                                                                               # If previewInterface
            self.markdownInterface.tkraise()                                                                                                                                                                    # Raise to top markdownInterface
            self.current = "m"                                                                                                                                                                                  # Set to markdownInterface
        elif self.current == "m":                                                                                                                                                                               # If markdownInterface
            self.rawInterface.tkraise()                                                                                                                                                                         # Raise to top rawInterface
            self.current = "r"                                                                                                                                                                                  # Set rawInterface

    def updateText(self, event):                                                                                                                                                                                # Originally this was called seperately from markdownDetect, but it ensures all text received on all 3 interfaces
        # Setting a char to use, as it doesn't detetc newline as a char when pressed.                                                                                                                           #
        choosenChar = event.char                                                                                                                                                                                # If anything but a newline is captured, this is the character
        if event.keysym == "Return":                                                                                                                                                                            # If it was a newline, than
            choosenChar = "\n"                                                                                                                                                                                  # we set that as the new char
                                                                                                                                                                                                                #
        if self.current == "r":                                                                                                                                                                                 # If rawInterface
            self.previewInterface.insert(tk.INSERT, choosenChar)                                                                                                                                                # Than add new char to previewInterface
            self.markdownInterface.insert(tk.INSERT, choosenChar)                                                                                                                                               # Than add new char to markdownInterface
        elif self.current == "p":                                                                                                                                                                               # If previewInterface
